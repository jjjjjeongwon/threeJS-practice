...
export default function example() {
  ...
  // Light
  // MeshBasicMaterial은 조명이 필요없다. -> Material중 가장 성능 좋음
  ...
  function draw() {
    ...
    texContext.fillStyle = 'green'; //붓에 물감 찍은 느낌
    texContext.fillRect(0, 0, 500, 500);
    texContext.fillStyle = 'white'; //붓에 물감 찍은 느낌
    texContext.fillRect(time * 50, 100, 50, 50);
    texContext.font = 'bold 50px sans-serif';
    texContext.fillText('우흥 ~', 200, 200);
